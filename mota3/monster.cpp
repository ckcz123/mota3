...
void c_monster::init(int t)
{
	...
	case 16:wcscpy_s(name,L"冥队长");position=15;hp=538;atk=376;def=98;money=26;break;
	...
	case 25:wcscpy_s(name,L"冥战士");position=24;hp=894;atk=508;def=112;money=32;break;
	...
	case 39:wcscpy_s(name,L"铁面人");position=34;hp=100;atk=200;def=0;money=33;special=3;break;

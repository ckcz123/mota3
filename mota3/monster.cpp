...
void c_monster::init(int t)
{
	...
	case 16:wcscpy_s(name,L"冥队长");position=15;hp=538;atk=376;def=98;money=31;break;
	...
	case 25:wcscpy_s(name,L"冥战士");position=24;hp=649;atk=409;def=112;money=32;break;
	case 26:wcscpy_s(name,L"骑士队长");position=25;hp=1356;atk=660;def=140;money=35;break;

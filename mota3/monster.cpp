...
void c_monster::init(int t)
{
	...
	switch(t)
	{
	case 1:wcscpy_s(name,L"绿色史莱姆");position=0;hp=75;atk=15;def=5;money=1;break;
	case 2:wcscpy_s(name,L"红色史莱姆");position=1;hp=100;atk=20;def=3;money=2;break;
	...
	case 8:wcscpy_s(name,L"冥灵魔王");position=7;hp=800;atk=550;def=90;money=21;break;
	...
	case 15:wcscpy_s(name,L"骷髅队长");position=14;hp=400;atk=100;def=30;money=13;special=1;break;
	case 16:wcscpy_s(name,L"冥队长");position=15;hp=769;atk=403;def=76;money=26;break;
	...
	case 21:wcscpy_s(name,L"初级卫兵");position=20;hp=300;atk=84;def=30;money=11;break;
	case 22:wcscpy_s(name,L"中级卫兵");position=21;hp=600;atk=136;def=65;money=18;break;
	case 23:wcscpy_s(name,L"高级卫兵");position=22;hp=500;atk=308;def=119;money=23;break;
	case 24:wcscpy_s(name,L"双手剑士");position=23;hp=456;atk=584;def=0;money=22;break;
	case 25:wcscpy_s(name,L"冥战士");position=24;hp=894;atk=508;def=112;money=28;break;
	case 26:wcscpy_s(name,L"骑士队长");position=25;hp=1356;atk=660;def=160;money=30;break;
	...
	case 39:wcscpy_s(name,L"铁面人");position=34;hp=111;atk=222;def=0;money=25;break;

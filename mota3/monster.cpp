...
void c_monster::init(int t)
{
	...
	case 8:wcscpy_s(name,L"冥灵魔王");position=7;hp=800;atk=550;def=90;money=30;break;
	...
	case 23:wcscpy_s(name,L"高级卫兵");position=22;hp=500;atk=297;def=119;money=23;break;
